...
public class UserController {
    ...
    */
    ...
    public String updateUserBasicInfo(HttpSession session, User user, UserSuppleInfo info, Model model, RedirectAttributes redirectAttributes, @ModelAttribute("birthdayString") String bs){
        ...
        try {
            Date birthday = df.parse(bs);
            info.setBirthday(birthday);
        } catch (ParseException ex) {
            result.setBirthdayError("生日格式错误");
        }
